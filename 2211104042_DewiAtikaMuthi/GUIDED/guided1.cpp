...
int main() {
    ...
    cout << "Menambahkan Alice di depan:" << endl;
    insertDepan(m1);
    tampil();

    cout << "Menambahkan Bob di belakang:" << endl;
    insertBelakang(m2);
    tampil();

    cout << "Menambahkan Charlie di depan:" << endl;
    insertDepan(m3);
    tampil();

    cout << "Menghapus elemen dari depan:" << endl;
    hapusDepan();
    tampil();

    cout << "Menghapus elemen dari belakang:" << endl;
    hapusBelakang();
    tampil();
